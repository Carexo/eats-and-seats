...
export const createOrder = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        if (userId) {
            ...
            newOrder = await new Order({user: userId, address, products: cart.products, total: cart.total, status: 'pending'}).save();
            ...
            newOrder = await new Order({email, address, products: mappedProducts, total: total, status: 'pending'}).save();
        }
